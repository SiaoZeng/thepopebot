...
import { createJobTool, getJobStatusTool, investigatePopebotCodebaseTool, getSkillBuildingGuideTool, getSkillDetailsTool, createStartHeadlessCodingTool, createGetRepositoryDetailsTool } from './tools.js';
...
export async function getJobAgent() {
  if (!_agent) {
    ...
    const tools = [createJobTool, getJobStatusTool, investigatePopebotCodebaseTool, getSkillBuildingGuideTool, getSkillDetailsTool];
